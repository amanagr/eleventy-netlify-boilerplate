...
function go_to_app_download_link(platform) {
  var request = new Request('https://api.github.com/repos/zulip/zulip-desktop/releases', {
    method: 'GET'
  });
  fetch(request).then(function (response) {
    ...
    const link = "https://github.com/zulip/zulip-desktop/releases/download/v" + version + "/" + PLATFORM_TO_SETUP_FILE[platform]
